...
public class Employee extends User {
    ...
    Employee(String name,String surname,String phone,String address,String username,String emp_name,String position){
        ...
        insertEmployee(createEMID(),emp_name,position,phone);
    }
    ...
    private static void insertEmployee(int EMID, String emp_name, String position, String phone)
    {
        try
        {
            createConnection();
            stmt = conn.createStatement();
            stmt.execute("insert into " + tableName + " values (" + EMID + ",'" + emp_name + "','" + position + "'," + User.phoneToUSID(phone) + ")");
            stmt.close();
            conn.commit();
            conn.close();
        }
